...
export const metadata = {
  title: 'Conditions Générales d\'Utilisation — Locentra',
}
      ...
      <main className="max-w-3xl mx-auto px-4 py-32">
        ...
        <div className="space-y-10 text-dark-300 text-sm leading-relaxed">
          <section>
            ...
            <p>
              Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation du service Locentra accessible à l'adresse <strong className="text-white">locentra.space</strong>.
            </p>
            <p className="mt-3">
              Locentra est un service d'analyse de visibilité locale pour les commerces et établissements, proposant un Score IA, des recommandations personnalisées et un suivi de progression.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              L'accès au service Locentra nécessite la création d'un compte utilisateur via notre système d'authentification (Clerk). Vous vous engagez à fournir des informations exactes et à maintenir la confidentialité de vos identifiants de connexion.
            </p>
            <p className="mt-3">
              Locentra se réserve le droit de suspendre ou supprimer tout compte ne respectant pas les présentes CGU.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Les paiements sont traités par <strong className="text-white">Stripe</strong>, prestataire de services de paiement sécurisé. Locentra n'a jamais accès à vos informations de carte bancaire.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              Locentra offre une <strong className="text-white">garantie de remboursement de 30 jours</strong> pour les nouveaux abonnés. Contactez-nous à contact@locentra.space pour en bénéficier.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Les scores, recommandations et analyses fournis par Locentra sont à titre indicatif. Ils reposent sur des données publiques et des algorithmes d'estimation. Locentra ne garantit pas de résultats spécifiques en termes de référencement, de visibilité ou de chiffre d'affaires.
            </p>
            <p className="mt-3">
              La responsabilité de Locentra est limitée au montant des sommes versées par l'utilisateur au cours des 12 derniers mois.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Le service Locentra, incluant ses algorithmes, son interface, ses textes et ses visuels, est la propriété exclusive de Locentra. Toute reproduction ou exploitation sans autorisation est interdite.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Locentra se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés par email de toute modification substantielle. La poursuite de l'utilisation du service après notification vaut acceptation des nouvelles CGU.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Pour toute question : <a href="mailto:contact@locentra.space" className="text-primary-400 hover:underline">contact@locentra.space</a>
            </p>
          </section>
        </div>
      </main>
