          ...
          return (
            <Card key={badge.slug} className={earned ? '' : 'opacity-40'}>
              <CardContent className="text-center py-5">
                <div
                  className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-3 border"
                  style={{
                    borderColor: earned ? badge.color + '40' : '#334155',
                    backgroundColor: earned ? badge.color + '15' : '#1e293b',
                  }}
                >
